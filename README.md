...
This plugin is compatible with Bad Update.
...
Then download [my fork of HvP2 with the xbdm replacement removed](https://github.com/theaperturecat/HvP2), add it to your dashlaunch config, replacing the original HvP2 if you have it.
...
Otherwise, if you are using VS2022 then due to changes in MSBuild you cannot use the default VS build rules, so you must put these commands in the Visual Studio Powershell window to build the project
